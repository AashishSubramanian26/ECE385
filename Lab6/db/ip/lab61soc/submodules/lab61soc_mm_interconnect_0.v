...
module lab61soc_mm_interconnect_0 (
		...
		output wire [1:0]  Add_s1_address,                                 //                                   Add_s1.address
		input  wire [31:0] Add_s1_readdata,                                //                                         .readdata
		output wire [1:0]  Execute_s1_address,                             //                               Execute_s1.address
		input  wire [31:0] Execute_s1_readdata,                            //                                         .readdata
	...
	wire   [31:0] execute_s1_agent_m0_readdata;                                                       // Execute_s1_translator:uav_readdata -> Execute_s1_agent:m0_readdata
	wire          execute_s1_agent_m0_waitrequest;                                                    // Execute_s1_translator:uav_waitrequest -> Execute_s1_agent:m0_waitrequest
	wire          execute_s1_agent_m0_debugaccess;                                                    // Execute_s1_agent:m0_debugaccess -> Execute_s1_translator:uav_debugaccess
	wire   [27:0] execute_s1_agent_m0_address;                                                        // Execute_s1_agent:m0_address -> Execute_s1_translator:uav_address
	wire    [3:0] execute_s1_agent_m0_byteenable;                                                     // Execute_s1_agent:m0_byteenable -> Execute_s1_translator:uav_byteenable
	wire          execute_s1_agent_m0_read;                                                           // Execute_s1_agent:m0_read -> Execute_s1_translator:uav_read
	wire          execute_s1_agent_m0_readdatavalid;                                                  // Execute_s1_translator:uav_readdatavalid -> Execute_s1_agent:m0_readdatavalid
	wire          execute_s1_agent_m0_lock;                                                           // Execute_s1_agent:m0_lock -> Execute_s1_translator:uav_lock
	wire   [31:0] execute_s1_agent_m0_writedata;                                                      // Execute_s1_agent:m0_writedata -> Execute_s1_translator:uav_writedata
	wire          execute_s1_agent_m0_write;                                                          // Execute_s1_agent:m0_write -> Execute_s1_translator:uav_write
	wire    [2:0] execute_s1_agent_m0_burstcount;                                                     // Execute_s1_agent:m0_burstcount -> Execute_s1_translator:uav_burstcount
	wire          execute_s1_agent_rf_source_valid;                                                   // Execute_s1_agent:rf_source_valid -> Execute_s1_agent_rsp_fifo:in_valid
	wire  [106:0] execute_s1_agent_rf_source_data;                                                    // Execute_s1_agent:rf_source_data -> Execute_s1_agent_rsp_fifo:in_data
	wire          execute_s1_agent_rf_source_ready;                                                   // Execute_s1_agent_rsp_fifo:in_ready -> Execute_s1_agent:rf_source_ready
	wire          execute_s1_agent_rf_source_startofpacket;                                           // Execute_s1_agent:rf_source_startofpacket -> Execute_s1_agent_rsp_fifo:in_startofpacket
	wire          execute_s1_agent_rf_source_endofpacket;                                             // Execute_s1_agent:rf_source_endofpacket -> Execute_s1_agent_rsp_fifo:in_endofpacket
	wire          execute_s1_agent_rsp_fifo_out_valid;                                                // Execute_s1_agent_rsp_fifo:out_valid -> Execute_s1_agent:rf_sink_valid
	wire  [106:0] execute_s1_agent_rsp_fifo_out_data;                                                 // Execute_s1_agent_rsp_fifo:out_data -> Execute_s1_agent:rf_sink_data
	wire          execute_s1_agent_rsp_fifo_out_ready;                                                // Execute_s1_agent:rf_sink_ready -> Execute_s1_agent_rsp_fifo:out_ready
	wire          execute_s1_agent_rsp_fifo_out_startofpacket;                                        // Execute_s1_agent_rsp_fifo:out_startofpacket -> Execute_s1_agent:rf_sink_startofpacket
	wire          execute_s1_agent_rsp_fifo_out_endofpacket;                                          // Execute_s1_agent_rsp_fifo:out_endofpacket -> Execute_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> Execute_s1_agent:cp_valid
	wire  [105:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> Execute_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // Execute_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [8:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> Execute_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> Execute_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> Execute_s1_agent:cp_endofpacket
	wire   [31:0] add_s1_agent_m0_readdata;                                                           // Add_s1_translator:uav_readdata -> Add_s1_agent:m0_readdata
	wire          add_s1_agent_m0_waitrequest;                                                        // Add_s1_translator:uav_waitrequest -> Add_s1_agent:m0_waitrequest
	wire          add_s1_agent_m0_debugaccess;                                                        // Add_s1_agent:m0_debugaccess -> Add_s1_translator:uav_debugaccess
	wire   [27:0] add_s1_agent_m0_address;                                                            // Add_s1_agent:m0_address -> Add_s1_translator:uav_address
	wire    [3:0] add_s1_agent_m0_byteenable;                                                         // Add_s1_agent:m0_byteenable -> Add_s1_translator:uav_byteenable
	wire          add_s1_agent_m0_read;                                                               // Add_s1_agent:m0_read -> Add_s1_translator:uav_read
	wire          add_s1_agent_m0_readdatavalid;                                                      // Add_s1_translator:uav_readdatavalid -> Add_s1_agent:m0_readdatavalid
	wire          add_s1_agent_m0_lock;                                                               // Add_s1_agent:m0_lock -> Add_s1_translator:uav_lock
	wire   [31:0] add_s1_agent_m0_writedata;                                                          // Add_s1_agent:m0_writedata -> Add_s1_translator:uav_writedata
	wire          add_s1_agent_m0_write;                                                              // Add_s1_agent:m0_write -> Add_s1_translator:uav_write
	wire    [2:0] add_s1_agent_m0_burstcount;                                                         // Add_s1_agent:m0_burstcount -> Add_s1_translator:uav_burstcount
	wire          add_s1_agent_rf_source_valid;                                                       // Add_s1_agent:rf_source_valid -> Add_s1_agent_rsp_fifo:in_valid
	wire  [106:0] add_s1_agent_rf_source_data;                                                        // Add_s1_agent:rf_source_data -> Add_s1_agent_rsp_fifo:in_data
	wire          add_s1_agent_rf_source_ready;                                                       // Add_s1_agent_rsp_fifo:in_ready -> Add_s1_agent:rf_source_ready
	wire          add_s1_agent_rf_source_startofpacket;                                               // Add_s1_agent:rf_source_startofpacket -> Add_s1_agent_rsp_fifo:in_startofpacket
	wire          add_s1_agent_rf_source_endofpacket;                                                 // Add_s1_agent:rf_source_endofpacket -> Add_s1_agent_rsp_fifo:in_endofpacket
	wire          add_s1_agent_rsp_fifo_out_valid;                                                    // Add_s1_agent_rsp_fifo:out_valid -> Add_s1_agent:rf_sink_valid
	wire  [106:0] add_s1_agent_rsp_fifo_out_data;                                                     // Add_s1_agent_rsp_fifo:out_data -> Add_s1_agent:rf_sink_data
	wire          add_s1_agent_rsp_fifo_out_ready;                                                    // Add_s1_agent:rf_sink_ready -> Add_s1_agent_rsp_fifo:out_ready
	wire          add_s1_agent_rsp_fifo_out_startofpacket;                                            // Add_s1_agent_rsp_fifo:out_startofpacket -> Add_s1_agent:rf_sink_startofpacket
	wire          add_s1_agent_rsp_fifo_out_endofpacket;                                              // Add_s1_agent_rsp_fifo:out_endofpacket -> Add_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> Add_s1_agent:cp_valid
	wire  [105:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> Add_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // Add_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [8:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> Add_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> Add_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> Add_s1_agent:cp_endofpacket
	...
	wire  [105:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> switches_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                              // switches_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire    [8:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> switches_s1_agent:cp_channel
	...
	wire          execute_s1_agent_rp_valid;                                                          // Execute_s1_agent:rp_valid -> router_008:sink_valid
	wire  [105:0] execute_s1_agent_rp_data;                                                           // Execute_s1_agent:rp_data -> router_008:sink_data
	wire          execute_s1_agent_rp_ready;                                                          // router_008:sink_ready -> Execute_s1_agent:rp_ready
	wire          execute_s1_agent_rp_startofpacket;                                                  // Execute_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          execute_s1_agent_rp_endofpacket;                                                    // Execute_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          add_s1_agent_rp_valid;                                                              // Add_s1_agent:rp_valid -> router_009:sink_valid
	wire  [105:0] add_s1_agent_rp_data;                                                               // Add_s1_agent:rp_data -> router_009:sink_data
	wire          add_s1_agent_rp_ready;                                                              // router_009:sink_ready -> Add_s1_agent:rp_ready
	wire          add_s1_agent_rp_startofpacket;                                                      // Add_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          add_s1_agent_rp_endofpacket;                                                        // Add_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire  [105:0] switches_s1_agent_rp_data;                                                          // switches_s1_agent:rp_data -> router_010:sink_data
	...
	wire          execute_s1_agent_rdata_fifo_src_valid;                                              // Execute_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] execute_s1_agent_rdata_fifo_src_data;                                               // Execute_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          execute_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_006:in_0_ready -> Execute_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> Execute_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> Execute_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // Execute_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> Execute_s1_agent:rdata_fifo_sink_error
	wire          add_s1_agent_rdata_fifo_src_valid;                                                  // Add_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] add_s1_agent_rdata_fifo_src_data;                                                   // Add_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          add_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_007:in_0_ready -> Add_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> Add_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> Add_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                  // Add_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> Add_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) execute_s1_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (sysid_qsys_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (execute_s1_agent_m0_address),                    // avalon_universal_slave_0.address
		.uav_burstcount         (execute_s1_agent_m0_burstcount),                 //                         .burstcount
		.uav_read               (execute_s1_agent_m0_read),                       //                         .read
		.uav_write              (execute_s1_agent_m0_write),                      //                         .write
		.uav_waitrequest        (execute_s1_agent_m0_waitrequest),                //                         .waitrequest
		.uav_readdatavalid      (execute_s1_agent_m0_readdatavalid),              //                         .readdatavalid
		.uav_byteenable         (execute_s1_agent_m0_byteenable),                 //                         .byteenable
		.uav_readdata           (execute_s1_agent_m0_readdata),                   //                         .readdata
		.uav_writedata          (execute_s1_agent_m0_writedata),                  //                         .writedata
		.uav_lock               (execute_s1_agent_m0_lock),                       //                         .lock
		.uav_debugaccess        (execute_s1_agent_m0_debugaccess),                //                         .debugaccess
		.av_address             (Execute_s1_address),                             //      avalon_anti_slave_0.address
		.av_readdata            (Execute_s1_readdata),                            //                         .readdata
		.av_write               (),                                               //              (terminated)
		.av_read                (),                                               //              (terminated)
		.av_writedata           (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (sysid_qsys_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (add_s1_agent_m0_address),                        // avalon_universal_slave_0.address
		.uav_burstcount         (add_s1_agent_m0_burstcount),                     //                         .burstcount
		.uav_read               (add_s1_agent_m0_read),                           //                         .read
		.uav_write              (add_s1_agent_m0_write),                          //                         .write
		.uav_waitrequest        (add_s1_agent_m0_waitrequest),                    //                         .waitrequest
		.uav_readdatavalid      (add_s1_agent_m0_readdatavalid),                  //                         .readdatavalid
		.uav_byteenable         (add_s1_agent_m0_byteenable),                     //                         .byteenable
		.uav_readdata           (add_s1_agent_m0_readdata),                       //                         .readdata
		.uav_writedata          (add_s1_agent_m0_writedata),                      //                         .writedata
		.uav_lock               (add_s1_agent_m0_lock),                           //                         .lock
		.uav_debugaccess        (add_s1_agent_m0_debugaccess),                    //                         .debugaccess
		.av_address             (Add_s1_address),                                 //      avalon_anti_slave_0.address
		.av_readdata            (Add_s1_readdata),                                //                         .readdata
		.av_write               (),                                               //              (terminated)
		.av_read                (),                                               //              (terminated)
		.av_writedata           (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (sysid_qsys_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (execute_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (execute_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (execute_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (execute_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (execute_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (execute_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (execute_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (execute_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (execute_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (execute_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (execute_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (execute_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (execute_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (execute_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (execute_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (execute_s1_agent_rp_startofpacket),              //                .startofpacket
		...
		.rf_sink_ready           (execute_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (execute_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (execute_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (execute_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (execute_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (execute_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (execute_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (execute_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (execute_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (execute_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),              //                .error
		.rdata_fifo_src_ready    (execute_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (execute_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (execute_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) execute_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (sysid_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (execute_s1_agent_rf_source_data),                //        in.data
		.in_valid          (execute_s1_agent_rf_source_valid),               //          .valid
		.in_ready          (execute_s1_agent_rf_source_ready),               //          .ready
		.in_startofpacket  (execute_s1_agent_rf_source_startofpacket),       //          .startofpacket
		.in_endofpacket    (execute_s1_agent_rf_source_endofpacket),         //          .endofpacket
		.out_data          (execute_s1_agent_rsp_fifo_out_data),             //       out.data
		.out_valid         (execute_s1_agent_rsp_fifo_out_valid),            //          .valid
		.out_ready         (execute_s1_agent_rsp_fifo_out_ready),            //          .ready
		.out_startofpacket (execute_s1_agent_rsp_fifo_out_startofpacket),    //          .startofpacket
		.out_endofpacket   (execute_s1_agent_rsp_fifo_out_endofpacket),      //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (sysid_qsys_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (add_s1_agent_m0_address),                        //              m0.address
		.m0_burstcount           (add_s1_agent_m0_burstcount),                     //                .burstcount
		.m0_byteenable           (add_s1_agent_m0_byteenable),                     //                .byteenable
		.m0_debugaccess          (add_s1_agent_m0_debugaccess),                    //                .debugaccess
		.m0_lock                 (add_s1_agent_m0_lock),                           //                .lock
		.m0_readdata             (add_s1_agent_m0_readdata),                       //                .readdata
		.m0_readdatavalid        (add_s1_agent_m0_readdatavalid),                  //                .readdatavalid
		.m0_read                 (add_s1_agent_m0_read),                           //                .read
		.m0_waitrequest          (add_s1_agent_m0_waitrequest),                    //                .waitrequest
		.m0_writedata            (add_s1_agent_m0_writedata),                      //                .writedata
		.m0_write                (add_s1_agent_m0_write),                          //                .write
		.rp_endofpacket          (add_s1_agent_rp_endofpacket),                    //              rp.endofpacket
		.rp_ready                (add_s1_agent_rp_ready),                          //                .ready
		.rp_valid                (add_s1_agent_rp_valid),                          //                .valid
		.rp_data                 (add_s1_agent_rp_data),                           //                .data
		.rp_startofpacket        (add_s1_agent_rp_startofpacket),                  //                .startofpacket
		...
		.rf_sink_ready           (add_s1_agent_rsp_fifo_out_ready),                //         rf_sink.ready
		.rf_sink_valid           (add_s1_agent_rsp_fifo_out_valid),                //                .valid
		.rf_sink_startofpacket   (add_s1_agent_rsp_fifo_out_startofpacket),        //                .startofpacket
		.rf_sink_endofpacket     (add_s1_agent_rsp_fifo_out_endofpacket),          //                .endofpacket
		.rf_sink_data            (add_s1_agent_rsp_fifo_out_data),                 //                .data
		.rf_source_ready         (add_s1_agent_rf_source_ready),                   //       rf_source.ready
		.rf_source_valid         (add_s1_agent_rf_source_valid),                   //                .valid
		.rf_source_startofpacket (add_s1_agent_rf_source_startofpacket),           //                .startofpacket
		.rf_source_endofpacket   (add_s1_agent_rf_source_endofpacket),             //                .endofpacket
		.rf_source_data          (add_s1_agent_rf_source_data),                    //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_007_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_007_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_007_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_007_out_0_error),              //                .error
		.rdata_fifo_src_ready    (add_s1_agent_rdata_fifo_src_ready),              //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (add_s1_agent_rdata_fifo_src_valid),              //                .valid
		.rdata_fifo_src_data     (add_s1_agent_rdata_fifo_src_data),               //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) add_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (sysid_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (add_s1_agent_rf_source_data),                    //        in.data
		.in_valid          (add_s1_agent_rf_source_valid),                   //          .valid
		.in_ready          (add_s1_agent_rf_source_ready),                   //          .ready
		.in_startofpacket  (add_s1_agent_rf_source_startofpacket),           //          .startofpacket
		.in_endofpacket    (add_s1_agent_rf_source_endofpacket),             //          .endofpacket
		.out_data          (add_s1_agent_rsp_fifo_out_data),                 //       out.data
		.out_valid         (add_s1_agent_rsp_fifo_out_valid),                //          .valid
		.out_ready         (add_s1_agent_rsp_fifo_out_ready),                //          .ready
		.out_startofpacket (add_s1_agent_rsp_fifo_out_startofpacket),        //          .startofpacket
		.out_endofpacket   (add_s1_agent_rsp_fifo_out_endofpacket),          //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	lab61soc_mm_interconnect_0_router_002 router_008 (
		.sink_ready         (execute_s1_agent_rp_ready),                      //      sink.ready
		.sink_valid         (execute_s1_agent_rp_valid),                      //          .valid
		.sink_data          (execute_s1_agent_rp_data),                       //          .data
		.sink_startofpacket (execute_s1_agent_rp_startofpacket),              //          .startofpacket
		.sink_endofpacket   (execute_s1_agent_rp_endofpacket),                //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (sysid_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_router_002 router_009 (
		.sink_ready         (add_s1_agent_rp_ready),                          //      sink.ready
		.sink_valid         (add_s1_agent_rp_valid),                          //          .valid
		.sink_data          (add_s1_agent_rp_data),                           //          .data
		.sink_startofpacket (add_s1_agent_rp_startofpacket),                  //          .startofpacket
		.sink_endofpacket   (add_s1_agent_rp_endofpacket),                    //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (sysid_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (sysid_qsys_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (execute_s1_agent_rdata_fifo_src_data),           //     in_0.data
		.in_0_valid     (execute_s1_agent_rdata_fifo_src_valid),          //         .valid
		.in_0_ready     (execute_s1_agent_rdata_fifo_src_ready),          //         .ready
	...
	lab61soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (sysid_qsys_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (add_s1_agent_rdata_fifo_src_data),               //     in_0.data
		.in_0_valid     (add_s1_agent_rdata_fifo_src_valid),              //         .valid
		.in_0_ready     (add_s1_agent_rdata_fifo_src_ready),              //         .ready
