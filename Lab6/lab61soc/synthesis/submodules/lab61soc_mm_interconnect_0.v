...
module lab61soc_mm_interconnect_0 (
	...
	wire  [104:0] add_s1_agent_rf_source_data;                                                        // Add_s1_agent:rf_source_data -> Add_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] add_s1_agent_rsp_fifo_out_data;                                                     // Add_s1_agent_rsp_fifo:out_data -> Add_s1_agent:rf_sink_data
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> Add_s1_agent:cp_valid
	wire  [103:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> Add_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // Add_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> Add_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> Add_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> Add_s1_agent:cp_endofpacket
	...
	wire  [103:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> switches_s1_agent:cp_data
	...
	wire          add_s1_agent_rp_valid;                                                              // Add_s1_agent:rp_valid -> router_008:sink_valid
	wire  [103:0] add_s1_agent_rp_data;                                                               // Add_s1_agent:rp_data -> router_008:sink_data
	wire          add_s1_agent_rp_ready;                                                              // router_008:sink_ready -> Add_s1_agent:rp_ready
	wire          add_s1_agent_rp_startofpacket;                                                      // Add_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          add_s1_agent_rp_endofpacket;                                                        // Add_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire  [103:0] switches_s1_agent_rp_data;                                                          // switches_s1_agent:rp_data -> router_009:sink_data
	...
	wire          add_s1_agent_rdata_fifo_src_valid;                                                  // Add_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] add_s1_agent_rdata_fifo_src_data;                                                   // Add_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          add_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_006:in_0_ready -> Add_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> Add_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> Add_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // Add_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> Add_s1_agent:rdata_fifo_sink_error
